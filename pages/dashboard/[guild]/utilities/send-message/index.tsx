...
const DashboardGuildSendMessagePage: React.FC<{ guild: Guild['id'] }> = ({ guild: guildId }) => {
  ...
  return (
    <Main>
      <Space direction="vertical" style={{ width: '100%' }}>
        ...
        />
        <Dashboard.SendMessage guild={guildId} />
      </Space>
    </Main>
  )
}
...
export default DashboardGuildSendMessagePage
