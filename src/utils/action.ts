...
export function isAction(object: any): object is IAction {
  ...
  return (
    ...
    (!('deletable' in action) || typeof action.deletable === 'boolean') &&
    (!('testOnly' in action) || typeof action.testOnly === 'boolean') &&
    (!('devsOnly' in action) || typeof action.devsOnly === 'boolean') &&
    (!('forceUpdate' in action) || typeof action.forceUpdate === 'boolean') &&
    ...
    (!('precondition' in action) || typeof action.precondition === 'function') &&
    'execute' in action &&
